    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdItensMenu = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensMenu", x => x.IdItensMenu);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdEntregador = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nome = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sobrenome = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Telefone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entregador_Clientes_EnderecoId",
                        column: x => x.EnderecoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pedidos_Entregador_EntregadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdItensPedido = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PedidoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItensMenuId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemMenuId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantidade = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensPedido", x => x.IdItensPedido);
                    table.ForeignKey(
                        name: "FK_ItensPedido_ItensMenu_ItemMenuId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entregador_EnderecoId",
                table: "Entregador",
                column: "EnderecoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItensPedido_ItemMenuId",
                table: "ItensPedido",
                column: "ItemMenuId");
